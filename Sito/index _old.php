...
<h1>Test Arduino</h1><br />
	<table border="1px" height="70" align="left">  
		<tr>
			...
			<td width=400><center>PIN 12<br /><div class="onoffswitch"><form>
												<input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch" onClick="location.href = 'index.php?action=toggle12&pwd=<? echo $password; ?>';" <? echo $pin12; ?>>
												<label class="onoffswitch-label" for="myonoffswitch">
													<span class="onoffswitch-inner"></span>
													<span class="onoffswitch-switch"></span>
												</label>
											</form></div></center></td>
			<td width=400><center>PIN 13<br /><div class="onoffswitch"><form>
												<input type="checkbox" name="onoffswitch_2" class="onoffswitch-checkbox" id="myonoffswitch" onClick="location.href = 'index.php?action=toggle13&pwd=<? echo $password; ?>';" <? echo $pin13; ?>>
												<label class="onoffswitch-label" for="myonoffswitch">
													<span class="onoffswitch-inner"></span>
													<span class="onoffswitch-switch"></span>
												</label>
